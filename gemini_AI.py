...
def get_conversational_chain():
    ...
    コンテキスト:\n{context}?\n
    質問: \n{question}\n. 理解しやすい言葉で回答を書き、より良い方法でフォーマットする前に、コンテキストの文言を要約して変更していることを確認してください。質問の最後に、答えはコンテクストに基づくものであり、正確さは出典から確認する必要があるという免責事項を可能な限り明確に書いてください。Do not repeat the question
    """
